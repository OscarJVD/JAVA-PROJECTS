...
public class registro_Usuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      response.setContentType("text/html");
        ...
        salida.println("<h1 style='text-align: center'>Nombre introducido</h1>" + request.getParameter("nombre"));
        salida.println("");
        salida.println("");
        salida.println("<h1 style='text-align: center'>Apellido introducido</h1>" + request.getParameter("apellido"));
        salida.println("");
        salida.println("");
