   ...
   intelectual.-->
    ...
    <!----------------------------------------------------------------------------------->
        ...
        <style>
            ...
            <title>Iniciar Sesion | Solumobil</title>
            ...
            <div class="container mt-4 col-lg-4">
                <div class="card col-sm-11">
                    <div class="card-body">
                        ...
                        <form class="form-sign" action="control?action=validar" method="POST">

                            <div class="form-group text-center">

                                <h3>Iniciar Sesión</h3>

                                <img src="img/logo.png" alt="70" 
                                     width="110" height="122"/>

                                <br><br>
                                <label>Te damos la bienvenida</label>
