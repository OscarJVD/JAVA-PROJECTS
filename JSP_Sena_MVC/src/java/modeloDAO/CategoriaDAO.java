...
public class CategoriaDAO extends Conexion{
    ...
    public ArrayList<CategoriaVO> listar() {      //Mostrar o listar los vehiculos -> retorna un arreglo
        ArrayList<CategoriaVO> listaCategorias = new ArrayList<CategoriaVO>(); //objeto arraylist de tipo VO
        ...
        try {
            ...
            while (mensajero.next()) //Si en el recorrido encuentra algo
            {
                ...
                listaCategorias.add(catVO); //agregar los datos al arreglo
            }
